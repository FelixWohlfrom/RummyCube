...
#include "SameNumberDifferentColor.h"

SameNumberDifferentColor::SameNumberDifferentColor(QWidget* parent) : StoneMover(parent)
{
    gamestones.push_back(new Gamestone(parent, &manager, true, Gamestone::StoneColor::BLUE, 5));
    gamestones.push_back(new Gamestone(parent, &manager, true, Gamestone::StoneColor::BLACK, 5));
    gamestones.push_back(new Gamestone(parent, &manager, true, Gamestone::StoneColor::YELLOW, 5));
