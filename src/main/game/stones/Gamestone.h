...
class Gamestone : public QWidget
{
	...
	public:
		 ...
		 */
		Gamestone(QWidget* parentWindow, StoneManager* stoneManager, bool isFirst, StoneColor color, int number);
	...
	private:
		...
		/**
		 * The position of the cursor where
		...
		/**
		 * This event is called once the gamestone is moved during
		 * drag'n'drop
		 */
