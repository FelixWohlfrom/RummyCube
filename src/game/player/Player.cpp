...
Player::Player(wxString name, StoneManager& stoneManager, int initialStonesLeftToTake, int sumInFirstRound, bool stonesInOneRow) :
...
wxString Player::getPlayerName() const
{
	return playerName;
}
...
void Player::newRound()
{
	...
	#ifdef _DEBUG
		std::cout << "===============================| Player " << this->playerName.mb_str() << ": Finished playing |==============================" << std::endl;
	#endif
}
...
{
	std::cout << "=====================| Stones of Player " << this->playerName.mb_str() << "|===============================" << std::endl;
