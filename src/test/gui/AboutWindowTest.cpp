...
void AboutWindowTest::verifyCloseByReturnKey()
{
    ...
    QVERIFY2(!aboutWindow->isVisible(), "Could not close about window using 'return' key");
}
...
void AboutWindowTest::verifyCloseByEscapeKey()
{
    ...
    QVERIFY2(!aboutWindow->isVisible(), "Could not close about window using 'escape' key");
}
